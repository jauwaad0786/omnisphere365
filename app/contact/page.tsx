    ...
    return (
      <div className="pt-24 pb-20 min-h-screen flex items-center">
        <div className="max-w-md mx-auto px-4 text-center">
          ...
          <p className="text-slate-400 text-sm">Our team will get back to you within 24 hours. Or reach us directly on WhatsApp for faster response.</p>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-5 gap-10 items-start">
          ...
          <div className="lg:col-span-2 space-y-5">
            {[
              { icon: Mail, label: 'Email Us', val: 'shaikhjauwaad@gmail.com', href: 'mailto:shaikhjauwaad@gmail.com', color: 'text-indigo-400' },
              { icon: Phone, label: 'Call Us', val: '+91 62079 47958', href: 'tel:6207947958', color: 'text-sky-400' },
              { icon: MapPin, label: 'Office', val: 'Delhi, India', href: '#', color: 'text-green-400' },
            ].map((c) => (
              <a key={c.label} href={c.href} className="flex items-center gap-4 glass glass-hover rounded-xl p-5 group">
                <div className="feature-icon group-hover:bg-indigo-500/25 transition-colors">
                  <c.icon size={20} className={c.color} />
                </div>
                <div>
                  <div className="text-slate-500 text-xs">{c.label}</div>
                  <div className="text-white text-sm font-medium mt-0.5">{c.val}</div>
                </div>
              </a>
            ))}
            ...
            <a href="https://wa.me/916207947958?text=Hi%2C%20I%27d%20like%20to%20know%20more%20about%20OmniSphere%20365."
              ...
              <div>
                <div className="text-[#25d366] text-sm font-semibold">Chat on WhatsApp</div>
          ...
          <div className="lg:col-span-3">
            <div className="glass rounded-2xl p-7 space-y-4">
              ...
              <div>
                <label className="block text-xs text-slate-400 mb-1.5">Interested In</label>
