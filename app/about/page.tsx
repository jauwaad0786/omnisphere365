    ...
    <div className="pt-24 pb-20">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-10 mb-20 items-center">
          <div>
            <h2 className="font-display font-bold text-3xl text-white mb-5">Our Story</h2>
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-20">
          <div className="glass rounded-2xl p-7 relative overflow-hidden">
            <div className="glow-orb w-40 h-40 bg-indigo-600/20 -top-10 -right-10" />
          ...
          <div className="glass rounded-2xl p-7 relative overflow-hidden">
            <div className="glow-orb w-40 h-40 bg-sky-600/20 -top-10 -right-10" />
            <div className="relative">
              <div className="text-3xl mb-4">🎯</div>
        ...
        {/* Why Choose Us */}
        <div className="mb-20">
          <h2 className="font-display font-bold text-2xl text-white mb-8 text-center">Why Choose OmniSphere 365</h2>
        ...
        {/* Team */}
        <div className="mb-16">
          <h2 className="font-display font-bold text-2xl text-white mb-8 text-center">Leadership Team</h2>
