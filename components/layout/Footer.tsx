          ...
          <div>
            ...
            <div className="space-y-2.5 text-sm text-slate-400">
              <div className="flex items-center gap-2 hover:text-accent-400 transition-colors">
                ...
                <a href="mailto:hello@oneplatform360.com">hello@oneplatform360.com</a>
              </div>
              <div className="flex items-center gap-2 hover:text-accent-400 transition-colors">
            ...
            <div className="flex gap-3 mt-6">
              {[
                ...
                <a key={i} href={href}
                  className="w-9 h-9 rounded-lg bg-white/5 border border-surface-darkBorder flex items-center justify-center text-slate-400 hover:text-accent-400 hover:border-accent-500/40 hover:bg-white/10 transition-all duration-300">
                  <Icon size={15} />
                </a>
              ))}
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {FOOTER_SERVICES.map((s) => (
                <li key={s.label}>
                  <Link href={s.href} className="text-sm text-slate-400 hover:text-accent-400 transition-colors duration-300">{s.label}</Link>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="space-y-2">
              <input type="email" placeholder="Enter your email"
                className="w-full bg-white/5 border border-surface-darkBorder rounded-xl px-4 py-2.5 text-sm text-white placeholder:text-slate-500 outline-none focus:border-accent-500/50 transition-all duration-300" />
              <button className="btn-primary w-full justify-center text-sm py-2.5 rounded-xl">Subscribe <ArrowRight size={14} /></button>
            </div>
            ...
            <a href="https://wa.me/916207947958" target="_blank" rel="noopener noreferrer"
              className="mt-5 flex items-center gap-2.5 px-4 py-3 rounded-xl bg-[#25d366]/10 border border-[#25d366]/25 text-[#3fdb7a] text-sm font-medium hover:bg-[#25d366]/15 transition-all duration-300">
